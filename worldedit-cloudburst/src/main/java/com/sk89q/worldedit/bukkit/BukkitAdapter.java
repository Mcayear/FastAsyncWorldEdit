...
//    }
     ...
     */
    @Nullable
    public static ItemType asItemType(String namespaceId) {
        //FAWE start - logic moved to IBukkitAdapter
        return getAdapter().asItemType(namespaceId);
        //FAWE end
    }
     ...
     */
    public static BaseItemStack adapt(Item itemStack) {
        //FAWE start - logic moved to IBukkitAdapter
