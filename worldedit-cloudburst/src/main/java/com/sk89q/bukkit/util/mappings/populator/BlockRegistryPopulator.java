...
public final class BlockRegistryPopulator {
    ...
    public static void initMapping2(BlockMappings blockMappings) {
        try (InputStream stream = WorldEditPlugin.
                getInstance().
                getInternalPlatform().
                getResourceLoader().
                getRootResource("mappings/blocks.json").openStream()) {
            ...
            PNX2FAWE.trim();
            blockMappings.setMapping2(PNX2FAWE);
        } catch (IOException e) {
    ...
    public static BlockMappings registerBlockMappings() {
        try (InputStream stream = WorldEditPlugin.
                getInstance().
                getInternalPlatform().
                getResourceLoader().
